...
export class LastRank extends Component {
	constructor(props) {
		super(props);
...
export const Cardsdata = [
	{ id: "1", title: "Institutes", text1: "18,645", icon1: "bi bi-cart-check fs-20", color1: "primary" },
	{ id: "2", title: "MD/MS Seats", text1: "35200", icon1: "bi bi-archive fs-20", color1: "secondary" },
	{ id: "3", title: "DNB Seats", text1: "4523", icon1: "bi bi-handbag fs-20",color1: "danger" },
	{ id: "4", title: "Diploma Seats", text1: "2812", icon1: "bi bi-currency-dollar fs-20",color1: "success"},
	{ id: "5", title: "Active Subscribers", text1: "", text2: "", icon1: "bi bi-bell fs-20",color1: "secondary" },
];
